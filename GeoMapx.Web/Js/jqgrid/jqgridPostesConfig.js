...
function initGridCodigoPostes() {
    $("#jqGridCodigoPostes").jqGrid({
        ...
        colModel: [
            ...
            { label: 'Observación', name: 'ObservacionPoste', width: 150, search: true },
            ...
            { label: 'Latitud', name: 'Lat', width: 150, search: false },
            { label: 'Longitud', name: 'Lon', width: 150, search: false },
        ],
        loadonce: true,
        colMenu: true,
        rownumbers: true,
        ...
        onSelectRow: function () {
            ...
            var scope = angular.element(document.getElementById('postesApp')).scope();
