...
namespace GeoMapx.Web.Utils
{
    public static class Utils
    {
        public static Coordenada ToLatLon(double utmX, double utmY, string utmZone)
        {
            ...
            return new Coordenada { latitude = latitude, longitude = longitude };
        }

        public static string ToJson(this object objeto, Formatting formmatting = Formatting.None)
        {
