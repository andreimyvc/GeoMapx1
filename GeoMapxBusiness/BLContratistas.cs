...
{
    public class BLContratistas
    {
        private int _empresaID;
        private int _userID;
        IContratistas repository;

        public BLContratistas(int empresaID, int userID)
        {
            this._empresaID = empresaID;
            this._userID = userID;
            this.repository = new DAL.Contratistas(); 
        }
        ...
        public List<Contratista> RetrieveAll()
        {
            try
            {
        ...
        public List<Contratista> RetrieveAllPaged(int page, int recordsPerPage)
        {
            try
            {
